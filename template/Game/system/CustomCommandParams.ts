...
class CustomCommandParams_9001 {
    battleResultSwitch: number; // = 1; 储存胜利结果
    allowEscape: boolean; // = false; 允许逃跑
    battleFailHandleType: number; // = 0; 战败处理
    enemyParty: number; // = 1; 敌人队伍
    enemyPartyVarID: number; // = 1; 敌人队伍
...
/**
* 自定义指令 9004-增减战斗者的生命值
*/
class CustomCommandParams_9004 {
    inPartyType: number; // = 1; 队伍
    battlerIndex: number; // = 0; 编号
    battlerIndexVarID: number; // = 1; 编号
    battlerIndexUseVar: number; // = 0; 使用变量指定
    symbol: number; // = 0; 操作
    value: number; // = 0; 值
...
class CustomCommandParams_9008 {
    ...
    createAni: number; // = 0; 敌人出现时使用的动画
    newInPartyIndexVarID: number; // = 1; 储存至
    saveNewInPartyIndex: boolean; // = false; 生成的敌人所在队伍内的编号
}
/**
* 自定义指令 9009-强制行动
*/
class CustomCommandParams_9009 {
    ...
    useVar: number; // = 0; 使用变量
    symbol: number; // = 0; 操作
    forceUse: boolean; // = true; 强制使用
    skillID: number; // = 1; 技能
    skillIDVarID: number; // = 1; 技能
    skillUseVar: number; // = 0; 使用变量
    itemID: number; // = 1; 道具
    itemIDVarID: number; // = 1; 道具
    itemUseVar: number; // = 0; 使用变量
    target: number; // = 0; 目标
    battlerIndex1: number; // = 0; 编号
    battlerIndexVarID1: number; // = 1; 编号
    battlerIndexUseVar1: number; // = 0; 使用变量指定
}
/**
* 自定义指令 9010-
*/
...
class CustomCommandParams_10002 {
    ...
    lvVarID: number; // = 1; 等级
    lvUseVar: number; // = 0; 使用变量
    applyBattle: boolean; // = false; 战斗中立刻生效
    allowDissolution: boolean; // = false; 允许解散
}
/**
* 自定义指令 10003-替换角色的技能
*/
class CustomCommandParams_10003 {
    ...
    enemyInPartyIndex: number; // = 0; 所在敌人队伍位置
    enemyInPartyIndexVarID: number; // = 1; 所在敌人队伍位置
    enemyInPartyIndexVarIDUseVar: number; // = 0; 使用变量
    symbol: number; // = 0; 操作
    skillID: number; // = 1; 技能
    skillIDVarID: number; // = 1; 技能
    skillUseVar: number; // = 0; 使用变量
...
class CustomCommandParams_10009 {
    ...
    actorInPartyIndexVarIDUseVar: number; // = 0; 使用变量
    face: string; // = "1"; 头像
    faceVarID: number; // = 1; 头像
    faceUseVar: number; // = 0; 使用变量
    avatar: number; // = 1; 行走图
    avatarVarID: number; // = 1; 行走图
    avatarUseVar: number; // = 0; 使用变量
    faceEnabled: boolean; // = false; 修改头像
    avatarEnabled: boolean; // = false; 修改行走图
    battlerEnabled: boolean; // = false; 修改战斗图
    battler: number; // = 1; 战斗图
    battlerVarID: number; // = 1; 战斗图
    battlerUseVar: number; // = 0; 使用变量
}
/**
* 自定义指令 10010-修改角色的技能
*/
